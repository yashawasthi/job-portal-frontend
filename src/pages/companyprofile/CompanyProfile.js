                  ...
                  {showPreviousWorks === false ? (
                    <div style={{ textAlign: "center" }}>
                      ...
                      <Typography variant="h6">
                        Write about all the previous tasks the company was involved
                        in
                      </Typography>
                    </div>
                  ) : (
                        ...
                        >
                          <div>
                            <ol>
                              <ul>
                                <Title>Title: </Title>
                                <Data>{work.title}</Data>
                                <br></br>
                                <Title>Duration: </Title>
                                <Data>
                                  {work.startingYear} till {work.endingYear}{" "}
                                </Data>
                                <br></br>
                          ...
                          <div style={{ display: "flex" }}>
                            <div>
                              <IconButton
                                onClick={() => {
                                  navigate(
                                    `/companyprofile/add-previous-work/edit/${work._id}`
                                  );
                                }}
                                style={{ color: "orange" }}
                              >
